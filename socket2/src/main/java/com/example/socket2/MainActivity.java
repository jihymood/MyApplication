...
//        etName = (EditText) findViewById(R.id.etName);
        ...
        //".104:80/JSR356-WebSocket/websocket/"
        ServerInfo[] serverInfos = {new ServerInfo("连接Java Web后台", "ws://192.168.0.105:8080/EBUS/webSocketServer?personId=12562"), new ServerInfo
...
//                        Log.d("MainActivity", "etName.getText().toString().trim()："+etMessage.getText().toString().trim());
                        client.send(etMessage.getText().toString().trim());
                        Log.d("MainActivity", etMessage.getText().toString().trim());
